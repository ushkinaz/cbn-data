...
```
https://raw.githubusercontent.com/ushkinaz/cbn-data/main/data/latest/all.json
```
...
```
https://raw.githubusercontent.com/ushkinaz/cbn-data/main/data/latest/lang/fr.json
```
...
```
https://raw.githubusercontent.com/ushkinaz/cbn-data/main/data/latest/lang/zh_CN_pinyin.json
```
